...
A multi-agent system (built with [CrewAI](https://www.crewai.com/)) that automates the kind of exploratory analysis I originally did by hand for my [AI & Data Job Market Tableau dashboard](https://github.com/AnanyaW2/ai-data-job-market-analysis) — turning a raw CSV of 1,500 job postings into a written executive summary, with three specialized agents each handling one stage of the pipeline.
